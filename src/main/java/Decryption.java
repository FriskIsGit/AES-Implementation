...
class Decryption extends Encryption{
    ...
    protected static byte inverseMultiplyByLookup(byte b, int times){
        switch (times){
            case 9:
