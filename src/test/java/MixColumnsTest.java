...
public class MixColumnsTest{
    ...
    public void testRow0Col0(){
        byte result1 = Main.multiply(byteRow0Col0,2);
        byte result2 = Main.multiply(byteRow1Col0,3);
        byte result3 = Main.multiply(byteRow2Col0,1);
        byte result4 = Main.multiply(byteRow3Col0,1);
        assertEquals((byte)0x4,result1^result2^result3^result4);
    }
    @Test
    public void testRow1Col0(){
        byte result1 = Main.multiply(byteRow0Col0,1);
    ...
    public void testRow2Col0(){
        byte result1 = Main.multiply(byteRow0Col0,1);
        byte result2 = Main.multiply(byteRow1Col0,1);
        byte result3 = Main.multiply(byteRow2Col0,2);
        byte result4 = Main.multiply(byteRow3Col0,3);
        assertEquals((byte)0x81,result1^result2^result3^result4);
    }
    @Test
    public void testRow3Col0(){
        byte result1 = Main.multiply(byteRow0Col0,3);
        byte result2 = Main.multiply(byteRow1Col0,1);
        byte result3 = Main.multiply(byteRow2Col0,1);
        byte result4 = Main.multiply(byteRow3Col0,2);
    ...
    public void testRow0Col1(){
        byte result1 = Main.multiply(byteRow0Col1,2);
        byte result2 = Main.multiply(byteRow1Col1,3);
        byte result3 = Main.multiply(byteRow2Col1,1);
        byte result4 = Main.multiply(byteRow3Col1,1);
        assertEquals((byte)0xe0,result1^result2^result3^result4);
    }
    @Test
    public void testRow1Col1(){
        byte result1 = Main.multiply(byteRow0Col1,1);
        byte result2 = Main.multiply(byteRow1Col1,2);
        byte result3 = Main.multiply(byteRow2Col1,3);
        byte result4 = Main.multiply(byteRow3Col1,1);
    ...
    public void testRow2Col1(){
        byte result1 = Main.multiply(byteRow0Col1,1);
        byte result2 = Main.multiply(byteRow1Col1,1);
        byte result3 = Main.multiply(byteRow2Col1,2);
        byte result4 = Main.multiply(byteRow3Col1,3);
        assertEquals((byte)0x19,result1^result2^result3^result4);
    }
    @Test
    public void testRow3Col1(){
        byte result1 = Main.multiply(byteRow0Col1,3);
        byte result2 = Main.multiply(byteRow1Col1,1);
        byte result3 = Main.multiply(byteRow2Col1,1);
        byte result4 = Main.multiply(byteRow3Col1,2);
    ...
    public void entireArrayTransformation(){
        ...
        assertArrayEquals(expected,Main.mixColumns(new byte[]{-44, -32, -72, 30, -65, -76, 65, 39, 93, 82, 17, -104, 48, -82, -15, -27}));
    }
}
